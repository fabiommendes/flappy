...
def desenhar():
    ...
    pyxel.blt(offset % (LARGURA + 32) - 32, ALTURA // 2, 2, 0, 16, 32, 32, 12)
    pyxel.blt((offset + 96) % (LARGURA + 32) - 32, ALTURA // 4, 2, 0, 48, 32, 32, 12)
    pyxel.blt(offset % (LARGURA + 32) - 64, ALTURA // 1.5, 2, 0, 80, 32, 32, 12)
